  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <i class="fa-solid fa-triangle-exclamation"></i>
        <h1 id="space" class="modal-title fs-5" id="modalLabel">Excluir cliente</h1>
        <h5 class="id"><?php echo $customer['id']; ?></h5>
      ...
      <div class="modal-footer">
        <a type="button" id="confirm" class="btn btn-secondary" data-bs-dismiss="modal.php" href="delete.php?id=<?php echo $customer['id']; ?>"><i class="fa-regular fa-circle-check"></i>  Sim</a>
